...
Include a priori power analysis, simulation-based power estimate, or
explicit sample-size justification (e.g., resource constraints, all
available participants).


## Experimental Design

When drafting a methods section, make key design decisions explicit
and justify them. Include power analysis or sample-size justification.
...
1.  **Write from the participant's perspective** — describe what they
    experienced, not what the researcher did to them.
2.  **Include counterbalancing and randomization details** — reviewers
    check for these; their absence reads as oversight.
3.  **Align methods with what the scripts actually did** — don't describe
    planned exclusions that weren't implemented, or vice versa.
